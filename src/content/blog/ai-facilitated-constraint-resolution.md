...
<div style="max-width: 600px; margin: 2.5rem auto; padding: 0;">
<svg viewBox="0 0 600 430" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: auto; font-family: 'Instrument Sans', system-ui, sans-serif;">
  <!-- Title -->
  <text x="300" y="28" text-anchor="middle" font-size="14" font-weight="600" fill="#292929">Stakeholder Conflict Web</text>

  <!-- Governance nodes (orange) -->
  <circle cx="150" cy="100" r="8" fill="#fe811b"/>
  <text x="150" y="82" text-anchor="middle" font-size="10" fill="#292929" font-weight="500">Fiscal discipline</text>
  <circle cx="300" cy="68" r="8" fill="#fe811b"/>
  <text x="300" y="52" text-anchor="middle" font-size="10" fill="#292929" font-weight="500">Proven utilization</text>

  <!-- Executive nodes (blue) -->
  <circle cx="470" cy="110" r="8" fill="#155dfc"/>
  <text x="470" y="92" text-anchor="middle" font-size="10" fill="#292929" font-weight="500">Near-term growth</text>
  <circle cx="510" cy="210" r="8" fill="#155dfc"/>
  <text x="510" y="196" text-anchor="middle" font-size="10" fill="#292929" font-weight="500">Competitive positioning</text>

  <!-- Medical staff nodes (teal) -->
  <circle cx="100" cy="230" r="8" fill="#0d9488"/>
  <text x="100" y="252" text-anchor="middle" font-size="10" fill="#292929" font-weight="500">Safe staffing ratios</text>
  <circle cx="230" cy="280" r="8" fill="#0d9488"/>
  <text x="230" y="302" text-anchor="middle" font-size="10" fill="#292929" font-weight="500">Sustainable schedules</text>

  <!-- Community nodes (purple) -->
  <circle cx="430" cy="310" r="8" fill="#7c3aed"/>
  <text x="430" y="334" text-anchor="middle" font-size="10" fill="#292929" font-weight="500">Timely access</text>
  <circle cx="300" cy="350" r="8" fill="#7c3aed"/>
  <text x="300" y="374" text-anchor="middle" font-size="10" fill="#292929" font-weight="500">Affordable services</text>

  <!-- Conflict lines (dashed, muted) -->
  <line x1="150" y1="100" x2="470" y2="110" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="150" y1="100" x2="510" y2="210" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="300" y1="68" x2="470" y2="110" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="300" y1="68" x2="430" y2="310" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="470" y1="110" x2="100" y2="230" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="470" y1="110" x2="230" y2="280" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="510" y1="210" x2="230" y2="280" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="510" y1="210" x2="300" y2="350" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="100" y1="230" x2="430" y2="310" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="100" y1="230" x2="510" y2="210" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="230" y1="280" x2="300" y2="68" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="430" y1="310" x2="150" y2="100" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="300" y1="350" x2="470" y2="110" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>
  <line x1="300" y1="350" x2="150" y2="100" stroke="#999" stroke-width="1" stroke-dasharray="4,3" opacity="0.6"/>

  <!-- Legend -->
  <circle cx="140" cy="400" r="5" fill="#fe811b"/>
  <text x="150" y="404" font-size="10" fill="#666">Governance</text>
  <circle cx="230" cy="400" r="5" fill="#155dfc"/>
  <text x="240" y="404" font-size="10" fill="#666">Executives</text>
  <circle cx="326" cy="400" r="5" fill="#0d9488"/>
  <text x="336" y="404" font-size="10" fill="#666">Medical Staff</text>
  <circle cx="434" cy="400" r="5" fill="#7c3aed"/>
  <text x="444" y="404" font-size="10" fill="#666">Community</text>
</svg>
</div>

<p style="text-align: center; font-size: 13px; color: #666; margin-top: -1rem; margin-bottom: 2rem;">Each line represents a tension between stakeholder requirements. No single person can see all of these at once.</p>
...
<div style="max-width: 520px; margin: 2.5rem auto; font-family: 'Instrument Sans', system-ui, sans-serif;">
  <div style="background: #292929; color: #fff; padding: 1rem 1.25rem; border-radius: 10px 10px 0 0; font-size: 15px; font-weight: 500;">
    "Extended procedural hours are not feasible."
  </div>
  <div style="background: #f8f8f8; border: 1px solid #e5e5e5; border-top: none; border-radius: 0 0 10px 10px; padding: 1rem 1.25rem;">
    <div style="font-size: 11px; text-transform: uppercase; letter-spacing: 0.05em; color: #999; margin-bottom: 0.75rem; font-weight: 600;">Hidden assumptions</div>
    <div style="display: flex; gap: 0.5rem; align-items: flex-start; margin-bottom: 0.6rem;">
      <span style="background: #fe811b; color: #fff; font-size: 11px; font-weight: 600; border-radius: 50%; width: 20px; height: 20px; display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0;">1</span>
      <span style="font-size: 14px; color: #292929;">"Extended" means overnight shifts, not early mornings or staggered starts</span>
    </div>
    <div style="display: flex; gap: 0.5rem; align-items: flex-start; margin-bottom: 0.6rem;">
      <span style="background: #155dfc; color: #fff; font-size: 11px; font-weight: 600; border-radius: 50%; width: 20px; height: 20px; display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0;">2</span>
      <span style="font-size: 14px; color: #292929;">Staffing must come from current employees working more hours</span>
    </div>
    <div style="display: flex; gap: 0.5rem; align-items: flex-start; margin-bottom: 0.6rem;">
      <span style="background: #0d9488; color: #fff; font-size: 11px; font-weight: 600; border-radius: 50%; width: 20px; height: 20px; display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0;">3</span>
      <span style="font-size: 14px; color: #292929;">Each shift must be financially self-sustaining in isolation</span>
    </div>
    <div style="margin-top: 0.75rem; padding-top: 0.75rem; border-top: 1px solid #e5e5e5; font-size: 13px; color: #666;">
      Challenge any one of these and new options appear.
    </div>
  </div>
</div>
