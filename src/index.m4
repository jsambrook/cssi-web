        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-image">
                    <img src="/assets/img/business_automation_1_500x400.jpg" alt="Business automation illustration">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="services-grid">
                <div class="service-card">
                    ...
                    <a href="services/ai-integration.html" class="btn secondary">Learn More</a>
                </div>
                <div class="service-card">
                    <div class="service-icon">BPA</div>
                    <h3>Business Process Automation</h3>
                    <p>Streamline workflows and reduce manual tasks with custom automation solutions.</p>
                    <a href="services/process-automation.html" class="btn secondary">Learn More</a>
                </div>
                <div class="service-card">
                    ...
                    <a href="services/revenue-improvement.html" class="btn secondary">Learn More</a>
                </div>
            </div>
        </div>
    </section>
